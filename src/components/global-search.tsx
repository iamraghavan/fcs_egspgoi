...
export function GlobalSearch() {
  ...
  const onSelect = React.useCallback((url: string) => {
    ...
    // Build target URL
    let targetUrl = url;
    // Check if URL is relative and append UID if necessary for dashboard consistency
  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-full h-10 bg-background/20 text-muted-foreground/80 pl-10 pr-4 rounded-md border border-sidebar-border text-sm flex items-center justify-between group-hover:bg-background/30 group-hover:text-sidebar-foreground transition-all">
