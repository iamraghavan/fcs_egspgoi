...
".dashboard-card",
 ...
 <CardTitle className="text-[11px] font-bold tracking-widest text-cds-text-05">{card.title}</CardTitle>
...
"h-4 w-4",
 ...
 <div className="flex items-center gap-2 text-[10px] text-cds-text-05 font-medium tracking-wide">
