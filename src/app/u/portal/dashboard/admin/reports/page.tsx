...
export default function DynamicReportsPage() {
 ...
 <span className="text-[10px] font-bold tracking-wider px-2 tabular-nums">Page {previewPage} of {totalPages || 1}</span>
 ...
 <th className="p-4 text-[11px] font-bold tracking-wider text-cds-text-05">Faculty Associate</th>
 <th className="p-4 text-[11px] font-bold tracking-wider text-cds-text-05">Department</th>
 <th className="p-4 text-[11px] font-bold tracking-wider text-cds-text-05 text-right cursor-pointer hover:bg-cds-ui-03 transition-colors"onClick={() => handleSortRanking('positive')}>
 <div className="flex items-center justify-end gap-1">
 Positive (+) {sortBy === 'positive' && (order === 'desc' ? <ArrowDown className="h-3 w-3"/> : <ArrowUp className="h-3 w-3"/>)}
 </div>
 </th>
 <th className="p-4 text-[11px] font-bold tracking-wider text-cds-text-05 text-right cursor-pointer hover:bg-cds-ui-03 transition-colors"onClick={() => handleSortRanking('negative')}>
 <div className="flex items-center justify-end gap-1">
 Negative (-) {sortBy === 'negative' && (order === 'desc' ? <ArrowDown className="h-3 w-3"/> : <ArrowUp className="h-3 w-3"/>)}
 </div>
 </th>
 <th className="p-4 text-[11px] font-bold tracking-wider text-cds-text-05 text-right cursor-pointer hover:bg-cds-ui-03 transition-colors"onClick={() => handleSortRanking('total')}>
 <div className="flex items-center justify-end gap-1 text-primary">
 Net Total {sortBy === 'total' && (order === 'desc' ? <ArrowDown className="h-3 w-3"/> : <ArrowUp className="h-3 w-3"/>)}
 </div>
 </th>
 <th className="p-4 text-[11px] font-bold tracking-wider text-cds-text-05 text-center cursor-pointer hover:bg-cds-ui-03 transition-colors"onClick={() => handleSortRanking('count')}>
 ...
 <div className="text-[10px] text-cds-text-05 font-mono tracking-widest">{row.facultyID}</div>
 </td>
...
"rounded-none font-bold tabular-nums min-w-[40px] justify-center",
 ...
 <p className="text-[10px] text-cds-text-05 font-bold tracking-widest text-center w-full">
 ...
 <CardDescription className="text-[10px] font-bold tracking-widest text-primary">Total Institution Points</CardDescription>
 ...
 <CardHeader className="pb-2">
 <CardDescription className="text-[10px] font-bold tracking-widest">Recorded Activities</CardDescription>
 <CardTitle className="text-2xl font-bold tabular-nums">{computedSummary?.count?.toLocaleString() || 0}</CardTitle>
 </CardHeader>
 </Card>
 <Card className="rounded-none shadow-none border-cds-ui-03">
 <CardHeader className="pb-2">
 <CardDescription className="text-[10px] font-bold tracking-widest">Avg Credit Velocity</CardDescription>
 ...
 <Legend verticalAlign="bottom"height={36} wrapperStyle={{ fontSize: '11px', textTransform: '', fontWeight: 'bold' }}/>
 </PieChart>
 </ResponsiveContainer>
 </CardContent>
 </Card>
 ...
 <thead className="bg-cds-ui-01 border-b">
 <tr className="text-left">
 <th className="p-4 text-[11px] font-bold tracking-wider text-cds-text-05">Date</th>
 <th className="p-4 text-[11px] font-bold tracking-wider text-cds-text-05">Faculty Associate</th>
 <th className="p-4 text-[11px] font-bold tracking-wider text-cds-text-05">Institutional Activity</th>
 <th className="p-4 text-[11px] font-bold tracking-wider text-cds-text-05">Type</th>
 <th className="p-4 text-[11px] font-bold tracking-wider text-cds-text-05">Status</th>
 <th className="p-4 text-[11px] font-bold tracking-wider text-cds-text-05 text-right">Pts</th>
 </tr>
 </thead>
 <tbody className="divide-y divide-cds-ui-03">
 {(paginatedData || []).map((row, i) => (
 ...
 <div className="text-[10px] text-cds-text-05 font-mono tracking-widest">{row.facultySnapshot?.facultyID || row.faculty || 'N/A'}</div>
 </td>
 <td className="p-4">
...
"rounded-none text-[10px] font-bold tracking-wider",
...
"p-4 text-right font-bold tabular-nums",
 ...
 <SelectTrigger className="w-[160px] bg-primary text-primary-foreground border-none rounded-none h-10 font-bold tracking-wider text-[11px] focus:ring-0">
 ...
 <CardTitle className="text-[11px] font-bold tracking-widest flex items-center gap-2">
 ...
 <label className="text-[10px] font-bold text-cds-text-05 tracking-widest">View Mode</label>
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold text-cds-text-05 tracking-widest">Scope</label>
 ...
 <label className="text-[10px] font-bold text-cds-text-05 tracking-widest">Select Department</label>
 ...
 <SelectLabel className="text-primary font-bold bg-muted/50 p-2 text-[10px] tracking-widest">{collegeName}</SelectLabel>
 ...
 <label className="text-[10px] font-bold text-cds-text-05 tracking-widest">Faculty Associate</label>
 ...
 <p className="text-[10px] text-cds-text-05 font-mono tracking-widest">{f.facultyID || 'N/A'} &middot; {f.department || 'N/A'}</p>
 </button>
 ))
 ) : !isUsersLoading ? (
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold text-cds-text-05 tracking-widest">Academic Cycle</label>
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold text-cds-text-05 tracking-widest">Credit Type</label>
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold text-cds-text-05 tracking-widest">Status</label>
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold text-cds-text-05 tracking-widest">Temporal Range</label>
 ...
 <p className="text-[9px] font-bold tracking-widest text-cds-text-05 text-center w-full">
