...
"bg-card rounded-lg border flex-col p-6 gap-6 h-fit sticky top-6 transition-all duration-300 shadow-sm",
 ...
 <CardTitle className="text-sm font-semibold tracking-wider text-muted-foreground">Original Remark</CardTitle>
 </CardHeader>
 ...
 <CardHeader className="pb-2 p-4">
 <CardTitle className="text-sm font-semibold tracking-wider text-primary">Your Reason</CardTitle>
 </CardHeader>
 <CardContent className="space-y-2 text-sm p-4 pt-0">
 ...
 <h4 className="font-semibold mb-4 text-sm tracking-wider text-muted-foreground">Appeal Timeline</h4>
 ...
 <div className="mt-6 border-t pt-6">
 <h4 className="font-semibold mb-4 text-sm tracking-wider text-muted-foreground">Actions</h4>
